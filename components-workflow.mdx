...
- [Inside WUI: writing components](#inside-wui-writing-components)
  - [1. Create or update a component folder](#1-create-or-update-a-component-folder)
  - [2. Implement the component](#2-implement-the-component)
  - [2.1 Use SCSS variables correctly in `.module.scss`](#21-use-scss-variables-correctly-in-modulescss)
  - [2.2 Accessibility (a11y)](#22-accessibility-a11y)
  - [3. Add tests](#3-add-tests)
  - [4. Write component docs](#4-write-component-docs)
- [Outside WUI: consuming components](#outside-wui-consuming-components)
  - [1. Install dependencies](#1-install-dependencies)
  - [2. Configure Vite with Tailwind plugin](#2-configure-vite-with-tailwind-plugin)
  - [3. Import global styles](#3-import-global-styles)
  - [4. Import and use components](#4-import-and-use-components)
  - [Tailwind vs SCSS modules](#tailwind-vs-scss-modules)
  - [4.1 Need a component variation that doesn't exist in WUI?](#41-need-a-component-variation-that-doesnt-exist-in-wui)
