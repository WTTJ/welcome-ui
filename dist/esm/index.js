...
helpers.textStyles = function (key) {
  return function (props) {
    var _props$theme = props.theme,
        fontFamily = _props$theme.fontFamily,
    ...
    return css(_templateObject(), defaultValues.family, defaultValues.size, defaultValues.weight, defaultValues.transform, defaultValues.spacing);
  };
};
