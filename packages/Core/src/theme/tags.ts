...
export const getTags = (theme: WuiTheme): ThemeTags => {
  ...
  return {
    ...
    variants: {
      ...
      1: { ...withoutVisibleBorder(colors['brand-blue']), color: colors['neutral-black'] },
      2: { ...withoutVisibleBorder(colors['brand-blue']), color: colors['neutral-white'] },
      3: { ...withoutVisibleBorder(colors['brand-orange']), color: colors['neutral-white'] },
      ...
      6: { ...withoutVisibleBorder(colors['brand-green']), color: colors['neutral-white'] },
