import type { CSSObject, CSSScalar } from '@xstyled/styled-components'
...
export interface WuiTheme {
  ...
  durations: DefaultTheme['durations']
  gridTemplateColumns: DefaultTheme['gridTemplateColumns']
  gridTemplateRows: DefaultTheme['gridTemplateRows']
  ringWidths: DefaultTheme['ringWidths']
  borders: DefaultTheme['borders']
  transitionProperties: DefaultTheme['transitionProperties']
  timingFunctions: DefaultTheme['timingFunctions']
  animations: DefaultTheme['animations']
  xstyled: DefaultTheme['xstyled']
