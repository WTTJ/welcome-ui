...
Set the select's width to the selected value's width. If there no value currently selected, it will use the placeholder's width.

⚠️ Not compatible with `Searchable` and `Creatable`

<div data-playground="auto-resize.tsx" data-component="Select"></div>
