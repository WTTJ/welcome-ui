...
<Playground>
  {() => {
    ...
    return (
      <>
        <Button as={Modal.Trigger} {...modal} onClick={() => setSize('sm')}>
          sm
        </Button>
        <Button as={Modal.Trigger} {...modal} onClick={() => setSize('md')}>
          md
        </Button>
        <Button as={Modal.Trigger} {...modal} onClick={() => setSize('lg')}>
          lg
        </Button>
        <Button as={Modal.Trigger} {...modal} onClick={() => setSize('auto')}>
          auto
        </Button>
...
Use `Modal.Cover` and `Modal.Footer` to style your Modal.
