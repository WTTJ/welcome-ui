...
Use `hint`, `warning`, `danger`, `info` or `success` properties on Field component to add a variant status on your checkbox. The label, hint or border color are set by magic 🪄
