...
export default {
  ...
  "/StickyNotes/docs/examples/button.tsx": dynamic(() => import("../../lib/src/components/StickyNotes/docs/examples/button.tsx").then(mod => mod), { ssr: false }),
  "/StickyNotes/docs/examples/close-button.tsx": dynamic(() => import("../../lib/src/components/StickyNotes/docs/examples/close-button.tsx").then(mod => mod), { ssr: false }),
  "/StickyNotes/docs/examples/icon.tsx": dynamic(() => import("../../lib/src/components/StickyNotes/docs/examples/icon.tsx").then(mod => mod), { ssr: false }),
  "/StickyNotes/docs/examples/overview.tsx": dynamic(() => import("../../lib/src/components/StickyNotes/docs/examples/overview.tsx").then(mod => mod), { ssr: false }),
  "/StickyNotes/docs/examples/shapes.tsx": dynamic(() => import("../../lib/src/components/StickyNotes/docs/examples/shapes.tsx").then(mod => mod), { ssr: false }),
  "/StickyNotes/docs/examples/variants.tsx": dynamic(() => import("../../lib/src/components/StickyNotes/docs/examples/variants.tsx").then(mod => mod), { ssr: false }),
