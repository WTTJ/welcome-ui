...
- ** the light colors are all white with opacity, you need to replace the old light color for text with new black color **
  - light.800 <-> neutral-20
  - light.700 <-> neutral-20
  - light.500 <-> neutral-40
  - light.200 <-> neutral-40
  - light.100 <-> neutral-50
...
- the color for html is now neutral-50
