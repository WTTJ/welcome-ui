...
Modal.Header no longer accept an icon props or a subtitle props. If you want to keep them, you need to passe the `icon` as an `iconName` prop to Modal.Body, and the `subtitle` as a `subtitle` prop to Modal.Body.
