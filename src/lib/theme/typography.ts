...
import { ThemeOptions, ThemeValues } from '.'
...
export const getFonts = (
  defaultFontFamily: ThemeOptions['defaultFontFamily'],
  headingFontFamily: ThemeOptions['headingFontFamily'],
  iconFontFamily: ThemeOptions['iconFontFamily']
): ThemeFonts => {
  return {
