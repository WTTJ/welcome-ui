...
export type ThemeTags = {
  default: CSSObject
  hover: Record<TagProps['variant'], CSSObject>
  icon: Record<TagProps['size'], string>
  shape: Record<TagProps['size'], CSSObject>
  sizes: Record<TagProps['size'], CSSObject>
  variants: Record<TagProps['variant'], CSSObject>
}
