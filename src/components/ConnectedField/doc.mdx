  ...
  {() => {
    ...
    const renderItem = option => (
      <Box display="flex" alignItems="center">
        <Icon name={option.value} mr="xs" /><span>{option.label}</span>
      </Box>
    )
    // Render
    return (
          ...
          return (
            <form onSubmit={handleSubmit}>
              ...
              <ConnectedField
                name="telephone"
                component={InputText}
                icon={<Icon name="phone" color="nude.500" />}
                type="tel"
              ...
              <FieldGroup label="Animals" mb="xl">
                <ConnectedField
                  ...
                  label={
                    <>
                      <span>Dogs are particularly </span>
                      <a href="#">funny creatures</a>
                      <span> due to their floppy ears</span>
                    </>
                  }
                  required
                />
              ...
              <ConnectedField
                ...
                mb="xl"
              >
                <DatePicker icon={<Icon name="celebrate" color="nude.600" />} />
                <TimePicker />
              </ConnectedField>
