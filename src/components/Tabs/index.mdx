...
<Playground>
   {() => {
    ...
    return (
      <>
        <Tabs handleActiveTab={name => setBloc(name)}>
          <TabsItem name="tab1">
            <div>Tab1</div>
          </TabsItem>
          <TabsItem name="tab2">
...
<Playground>
  <Tabs
    ...
    handleActiveTab={name => console.log(`you have selected tabs "${name}"`)}
  >
    <TabsItem name="tab1">
      <div>Tab1</div>
    </TabsItem>
...
You can add a badge on set `badgeContent` on TabsItem component.
...
<Playground>
  ...
  >
    ...
    <TabsItem name="tab2" badgeContent="4">
      <div>Tab2</div>
    </TabsItem>
    <TabsItem name="tab3" badgeContent="new">
      <div>Tab3</div>
    </TabsItem>
  </Tabs>
</Playground>
...
<Playground>
  {() => {
    ...
    return (
      <>
      <Tabs handleActiveTab={name => setBloc(name)} defaultActiveTab={bloc}>
        <TabsItem name="tab1">
          <div>Tab1</div>
        </TabsItem>
        <TabsItem name="tab2">
...
<Playground>
  {() => {
    ...
    return (
      <>
      <Tabs handleActiveTab={name => scrollToBloc(name)}>
        <TabsItem name="tab1">
          <div>Tab1</div>
        </TabsItem>
        <TabsItem name="tab2">
