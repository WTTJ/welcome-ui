...
<Playground>
  {() => {
    ...
    const getVariant = tab => tab.selectedId === tab ? 'primary' : 'default'
    return (
      <>
        <TabList aria-label="Tabs" {...tab}>
          <Tab {...tab} stopId="tab1">
            Tab 1 <Badge ml="xs"  variant={getVariant('tab1')}>new</Badge>
          </Tab>
          <Tab {...tab} stopId="tab2">
            Tab 2 <Badge ml="xs" variant={getVariant('tab2')}>old</Badge>
          </Tab>
          <Tab {...tab} stopId="tab3">
            Tab 3
          </Tab>
