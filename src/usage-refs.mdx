  ...
  {() => {
    ...
    return (
      <Form>
        ...
        />
        <Field name="lastName" component={InputText} label="Normal field" ref={normalInputRef} />
        <Label>Naked field</Label>
        <InputText name="naked" ref={nakedInputRef} />
        <Field name="avatar" component={FileUpload} label="Complex field" ref={fileUploadRef} />
