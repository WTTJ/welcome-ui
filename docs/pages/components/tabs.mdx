...
## Sizes
Available sizes are `sm` and `md`. By default size is set to `md`.
...
function() {
  ...
  return (
    <>
      ...
      <br/>
      <Tab.List aria-label="Tabs" {...tab}>
        <Tab {...tab} size="sm" id="tab1">
          Tab 1
        </Tab>
        <Tab {...tab} size="sm" id="tab2">
          Tab 2
        </Tab>
        <Tab {...tab} size="sm" id="tab3">
          Tab 3
        </Tab>
      </Tab.List>
      <Tab.Panel {...tab} tabId="tab1">
...
Add badges, icons and image in tab.
