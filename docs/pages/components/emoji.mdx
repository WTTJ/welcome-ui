...
We rely on [bowser](https://www.npmjs.com/package/bowser/v/2.11.0) to check the user's OS, if it's an Apple one then we will display Apple's emojis, otherwise Google's (like Slack).  
