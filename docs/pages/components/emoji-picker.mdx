...
function Default() {
  ...
  return (
    <>
      <EmojiPicker.Trigger as={Button} state={emojiPicker}>
        {emoji ? <Emoji emoji={emoji} /> : 'Open Emoji Picker'}
      </EmojiPicker.Trigger>

      <EmojiPicker onChange={setEmoji} value={emoji} state={emojiPicker} />
    </>
  )
}
```
...
function Custom() {
  ...
  return (
    <>
      ...
      <EmojiPicker onChange={setEmoji} state={emojiPicker}>
...
function BasicList() {
  ...
  return (
    <>
      ...
      <EmojiPicker onChange={setEmoji} state={emojiPicker} emptyList="Pas d'emojis">
