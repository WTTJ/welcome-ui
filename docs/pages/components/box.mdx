...
Box is the low level component of Welcome UI, it build all other components on our design system. By default, it’s a div element.
...
You can simply create a card item.
