...
To show a close button you need to pass your function on the `handleClose` property. You can also add a custom data-testid on this button with `closeButtonDataTestId` property.
