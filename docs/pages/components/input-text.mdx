...
function () {
  ...
  return <InputText icon={<AvatarIcon color="dark-900" />} name="firstName3" placeholder="Boaty" value={value} onChange={handleChange} />
}
```
...
```jsx
<Stack spacing="xl">
  <InputText name="extra-small" placeholder="Placeholder" size="xs" />
  <InputText name="small" placeholder="Placeholder" size="sm" />
  <InputText name="medium" placeholder="Placeholder" />
  <InputText name="large" placeholder="Placeholder" size="lg" />
</Stack>
```
