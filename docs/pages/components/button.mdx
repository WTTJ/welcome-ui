...
You can transform your Button component with `ButtonLink` component, `href` or `to`... all that you want.

```jsx
<ButtonLink href="https://www.welcometothejungle.co" target="_blank" rel="noopener nofollow">
  <SunIcon />
  <span>Welcome</span>
</ButtonLink>
```
