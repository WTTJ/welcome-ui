...
const newColorValues = {
  ...
  'sub-1': 'v6.secondary-blue',
  'sub-2': 'v6.secondary-blue',
  'sub-3': 'v6.secondary-red',
  'sub-4': 'v6.secondary-red',
  'sub-5': 'v6.secondary-green',
  'sub-6': 'v6.secondary-green',
  'sub-7': 'v6.secondary-purple',
}
...
glob(pattern, (error, matches) => {
  ...
  matches.forEach(async match => {
    if (match === './packages/Core/src/theme/colors.ts') return
