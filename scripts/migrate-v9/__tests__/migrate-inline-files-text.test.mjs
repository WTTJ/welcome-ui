...
describe('Inline Migration - Text Components', () => {
  const tempDir = setupMigrationTest('inline-text-test', '__fixtures__')

  it('migrates Text components with typography and spacing props to span with classNames', async () => {
    // Run migration
