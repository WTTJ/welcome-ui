...
<div data-playground="variants.tsx" data-component="StickyNotes"></div>

## Action

A call-to-action encouraging the user to take an action. It's a predefined button styled to fit within the StickyNotes component.

<div data-playground="button.tsx" data-component="StickyNotes"></div>
...
<div data-playground="shapes.tsx" data-component="StickyNotes"></div>
...
<div data-playground="icon.tsx" data-component="StickyNotes"></div>

## Close Button

Add `handleClose` prop to include a close button, allowing users to dismiss the sticky note when it's no longer needed.

<div data-playground="close-button.tsx" data-component="StickyNotes"></div>
