...
<div data-playground="custom-content.tsx" data-component="Swiper"></div>

### With controls below slides

When using `placement="inline"`, you can place controls after `Swiper.Slides` to keep buttons under your slides.

<div data-playground="custom-content-below.tsx" data-component="Swiper"></div>
...
<div data-playground="controls.tsx" data-component="Swiper"></div>
