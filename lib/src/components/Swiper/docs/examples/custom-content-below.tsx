...
const Example = () => {
  const swiper = useSwiper({ slides: { perView: { desktop: 2, mobile: 1, tablet: 2 } } })

  return (
    <Swiper className="h-400" store={swiper}>
      <Text className="mb-xl" variant="heading-lg">
        Swiper
      </Text>
      <Swiper.Slides>
        <img
      ...
      <div className="flex gap-4 mt-xl">
        <Swiper.PrevButton placement="inline" />
        <Swiper.NextButton placement="inline" />
      </div>
    </Swiper>
  )
}
