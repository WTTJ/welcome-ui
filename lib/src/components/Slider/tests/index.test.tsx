...
describe('<Slider> test', () => {
  ...
  it('ensure min value is respected', () => {
    const handleChange = vi.fn()
    const min = 0
    const { container } = render(<Slider max={100} min={min} onChange={handleChange} value={50} />)
  ...
  it('ensure max value is respected', () => {
    const handleChange = vi.fn()
    const max = 100
    const { container } = render(<Slider max={max} min={0} onChange={handleChange} value={50} />)
  ...
  it('ensure value is rounded to the < value when there is a step', () => {
    const handleChange = vi.fn()
    const { container } = render(
      <Slider max={100} min={0} onChange={handleChange} step={10} type="right-field" value={12} />
    )
  ...
  it('ensure value is rounded to the > value when there is a step', () => {
    const handleChange = vi.fn()
    const { container } = render(
      <Slider max={100} min={0} onChange={handleChange} step={10} type="right-field" value={56} />
    )
  ...
  it('Slider and left field should be disabled', () => {
    ...
    const value = 30
    const { container } = render(
      <Slider disabled max={100} min={0} onChange={handleChange} type="left-field" value={value} />
    )
  ...
  it('Slider and right field should be disabled', () => {
    ...
    const value = 30
    const { container } = render(
      <Slider disabled max={100} min={0} onChange={handleChange} type="right-field" value={value} />
    )
