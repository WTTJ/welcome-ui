...
<div data-playground="icon.tsx" data-component="Breadcrumb"></div>

### Collapsed items

You can collapse items to save space.

<div data-playground="collapsed.tsx" data-component="Breadcrumb"></div>

### Overflow gradient

A gradient effect will be applied to indicate overflowed items.

<div data-playground="gradient.tsx" data-component="Breadcrumb"></div>
