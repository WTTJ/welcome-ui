...
<div data-playground="sort.tsx" data-component="Table"></div>

### With elevation

You can pass the props `withElevation` to `Table` to show borders and elevation.

<div data-playground="elevation.tsx" data-component="Table"></div>
