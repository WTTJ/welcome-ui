...
Cards become interactive (clickable and selectable) when `onClick` prop are provided, unless the `disabled` prop is set to true.

<div data-playground="interactive.tsx" data-component="Card"></div>
